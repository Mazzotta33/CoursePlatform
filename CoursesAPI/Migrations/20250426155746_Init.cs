        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhotoKey = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewPhotoKey = table.Column<string>(type: "text", nullable: false),
                    Admins = table.Column<Dictionary<string, string>>(type: "hstore", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "integer", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    VideoKeys = table.Column<List<string>>(type: "text[]", nullable: false),
                    LectureKeys = table.Column<List<string>>(type: "text[]", nullable: false),
                    PhotoKeys = table.Column<List<string>>(type: "text[]", nullable: false),
                    BookKeys = table.Column<List<string>>(type: "text[]", nullable: false),
                    AudioKeys = table.Column<List<string>>(type: "text[]", nullable: false),
                    TextLectures = table.Column<List<string>>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateChatRecipientId = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_PrivateChatRecipientId",
                        column: x => x.PrivateChatRecipientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestResults_LessonProgresses_LessonProgressId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "e2e64d15-76f2-4920-a540-0a399357f645", null, "User", "USER" },
                    { "fa7ae7d7-712b-40db-a53f-03b88c93c4a0", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_PrivateChatRecipientId",
                table: "Messages",
                column: "PrivateChatRecipientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_LessonProgressId",
                table: "TestResults",
